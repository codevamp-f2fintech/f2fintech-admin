                                    ...
                                    <CardContent sx={{ p: 2 }}>
                                        ...
                                        <Box sx={{
                                            ...
                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                                <Avatar sx={{ width: 32, height: 32, bgcolor: "#9575cd" }}>
                                        ...
                                        <Box sx={{
                                            ...
                                            >
                                                <source src={voiceNote.voice_note_url} type="audio/mpeg" />
                                                <source src={voiceNote.voice_note_url} type="audio/ogg" />
                                                <source src={voiceNote.voice_note_url} type="audio/wav" />
