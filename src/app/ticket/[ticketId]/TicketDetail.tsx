          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={6}>
              <Typography sx={{ color: "white", mb: 1 }}>
                <strong>Name:</strong> {capitalizeFirstLetter(ticketDetailData?.customerName)}
              </Typography>
              <Typography
                sx={{
                  color: "white",
            ...
            <Grid item xs={12} sm={6}>
              <Typography sx={{ color: "white", mb: 1 }}>
                <strong>Contact:</strong> +91 {ticketDetailData?.customerContact}
              </Typography>
              <Typography sx={{ color: "white", mb: 1 }}>
                <strong>Designation:</strong> {capitalizeFirstLetter(ticketDetailData?.customerDesignation)}
              </Typography>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              <Typography sx={{ color: "white", mb: 1 }}>
                <strong>Location:</strong> {capitalizeFirstLetter(ticketDetailData?.customerLocation)}
              </Typography>
              <Typography sx={{ color: "white", mb: 1 }}>
                <strong>Tenure:</strong> {formatTenure(ticketDetailData?.applicationTenure)}
              </Typography>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              <Typography sx={{ color: "white", mb: 1 }}>
                <strong>Amount:</strong> {formatAmount(ticketDetailData?.applicationAmount)}
              </Typography>
