      ...
      <Container maxWidth="xl">
        ...
        <Grid container spacing={3}>
                  ...
                  <CardContent sx={{ p: 3, minHeight: "30vh" }}>
                    <Box
                      sx={{
                        ...
                        alignItems: "start",
                        mb: 0,
                        flexDirection: { xs: "column", md: "row", sm: "row" }, // Column on mobile, row on desktop
                        gap: { xs: 2, md: 0 }, // Add gap between items in column layout
                      }}
                    >
                      {/* Image - will appear below on mobile */}
                      <Box
                        sx={{
                          width: { xs: "100%", md: "50%" }, // Full width on mobile, half on desktop
                          height: { xs: "auto", md: "28vh" }, // Auto height on mobile
                          display: "flex",
                      ...
                      >
                        <img
                          ...
                          style={{
                            width: "100%",
                            height: "100%",
                            objectFit: "contain", // Changed from "fit" to "contain" for better responsiveness
                          }}
                        />
                      </Box>

                      {/* Text - will appear above on mobile */}
                      <Box
                        sx={{
                          width: { xs: "100%", md: "55%" }, // Full width on mobile
                          paddingLeft: { xs: 0, md: 2 }, // No left padding on mobile
          ...
          {!hasMoreData && !swrLoading && (
            <Typography
              sx={{ width: "100%", textAlign: "center", mt: 4, color: "black" }}
            >
